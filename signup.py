...
def show_signup():
    ...
    /* Nav Sign In (Column 3) / "Already have an account" (Column 5) */
    ...
    with left_side:
        ...
        <style>
          *{{margin:0;padding:0;box-sizing:border-box;}} 
          ...
          .brand-card {{
            background: url(data:image/jpeg;base64,{CHART_IMAGE_B64}) center/cover;
        ...
        <div class="brand-card">
          ...
          <div class="content">
            ...
            <h2 style="font-family:'Syne',sans-serif; font-size:36px; font-weight:800; color:#ffffff; line-height:1.1; letter-spacing:-1.5px; margin-bottom:24px;">
              Get started with <span style="color:#E8500A;">SmartViz.</span>
            </h2>
            ...
            <p style="font-family:'Inter',sans-serif; font-size:15px; color:rgba(255,255,255,0.7); line-height:1.6; margin-bottom:40px; max-width:320px;">
              Join industry leaders turning complex building data into actionable decisions in seconds.
            </p>
            ...
            <div style="background:rgba(255,255,255,0.03); backdrop-filter:blur(10px); border:1px solid rgba(255,255,255,0.1); border-radius:16px; padding:28px;">
              <div style="display:flex;flex-direction:column;gap:18px;">
                <div style="display:flex;align-items:center;gap:12px;">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/><line x1="8" y1="16" x2="8" y2="16"/><line x1="16" y1="16" x2="16" y2="16"/></svg>
                  <span style="font-size:14px;color:rgba(255,255,255,0.9);font-weight:500;">
                    Agent-driven analytics pipeline</span>
                </div>
                <div style="display:flex;align-items:center;gap:12px;">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#E8500A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                  <span style="font-size:14px;color:rgba(255,255,255,0.9);font-weight:500;">
                    Enterprise-grade security & privacy</span>
                </div>
                <div style="display:flex;align-items:center;gap:12px;">
    ...
    with right_side:
        ...
        <p style="font-size:16px;color:#6b7280;font-family:'Inter',sans-serif;margin-bottom:32px; font-weight:500;">
            Free access to your building analytics.
        </p>
        ...
        email    = st.text_input("Work email", placeholder="you@university.ac.uk", key="signup_email")
        ...
        if st.button("Create account", key="signup_btn"):
            if not name or not email or not password:
                ...
                if user_id:
                    ...
                    st.error("Email already in use. Please sign in instead.")
